...
import { getDramaId, getDramaTitle, getDramaCover, getDramaVip } from '../utils';
    ...
    <div className="pb-20">
      ...
      {heroDrama && (
        <div className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden">
          ...
          <img 
            src={getDramaCover(heroDrama)} 
            alt={getDramaTitle(heroDrama)}
          ...
          <div className="absolute bottom-0 left-0 z-20 p-6 md:p-16 w-full md:w-2/3">
            ...
            >
              {heroDrama.introduction || 'No description available.'}
            </motion.p>
            ...
            >
              <Link 
                to={`/detail/${getDramaId(heroDrama)}`}
    ...
    <section>
      ...
      <div className="flex overflow-x-auto gap-4 pb-4 snap-x snap-mandatory scrollbar-hide" style={{ scrollbarWidth: 'none' }}>
        {dramas.map((drama) => {
          ...
          const isItemVip = isVip || getDramaVip(drama);
